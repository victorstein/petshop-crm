            ...
            <form className='mt-6 mb-4 md:hidden'>
              <div className='mb-3 pt-0'>
                <input
                  type='text'
                  placeholder='Search'
                  className='border-0 px-3 py-2 h-12s border-solid  border-blueGray-500 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-base leading-snug shadow-none outline-none focus:outline-none w-full font-normal'
                />
              </div>
            </form>
            ...
            <ul className='md:flex-col md:min-w-full flex flex-col list-none'>
              ...
              <li className='items-center'>
                <Link
                  ...
                  className={
                    'text-xs uppercase py-3 font-bold block ' +
                    (router.pathname.includes('/admin/tables')
                      ? 'text-lightBlue-500 hover:text-lightBlue-600'
                      : 'text-blueGray-700 hover:text-blueGray-500')
                  }
                >
              ...
              <li className='items-center'>
                <Link
                  ...
                  className={
                    'text-xs uppercase py-3 font-bold block ' +
                    (router.pathname.includes('/admin/maps')
                      ? 'text-lightBlue-500 hover:text-lightBlue-600'
                      : 'text-blueGray-700 hover:text-blueGray-500')
                  }
                >
